...
# tarball bakes the pinned browser bundle once; CMake subsequently embeds those
# files into akcore. Refuse to make a release tarball without the real bundle.
