#!/usr/bin/env bash
# Remove an installed Agent Kate. On Arch this uses pacman; otherwise it
# removes the files recorded in build/install_manifest.txt.
#
...
# --- non-Arch: use the install manifest -------------------------------------
